...
{name:'Jessica Toro',campus:'Trenton Campus'},
{name:'Joleen Rhoden',campus:'Lawrence Campus'},
]},
{catKey:'teachingStaff',color:'#4CAF50',icon:String.fromCodePoint(0x1F4DA),people:[
{name:'Mary Allen',campus:'Trenton Campus',room:'1'},
{name:'Julie Olsen',campus:'Trenton Campus',room:'2'},
{name:'Kelly McCormick',campus:'Trenton Campus',room:'3'},
{name:'Deborah Long',campus:'Trenton Campus',room:'4'},
{name:'Ayesha Rahman',campus:'Trenton Campus',room:'5'},
{name:'Diane Howard',campus:'Trenton Campus',room:'6'},
{name:'Lisa Verdi',campus:'Trenton Campus',room:'7'},
{name:'Julie Moyer',campus:'Lawrence Campus',room:'1'},
{name:'Pamela Rodriguez',campus:'Lawrence Campus',room:'2'},
{name:'__OPEN__',campus:'Lawrence Campus',room:'3'},
]},
{catKey:'substituteTeachers',color:'#8BC34A',icon:String.fromCodePoint(0x1F4D6),people:[
{name:'Advika Rao',campus:'Lawrence Campus'},
]},
{catKey:'teacherAssistants',color:'#4BA3E3',icon:String.fromCodePoint(0x1F91D),people:[
{name:'Delia Lima',campus:'Trenton Campus',room:'1'},
{name:'Jameliz Brisita',campus:'Trenton Campus',room:'2'},
{name:'Deborah Tyler',campus:'Trenton Campus',room:'3'},
{name:'Joelliz Brisita',campus:'Trenton Campus',room:'4'},
{name:'Margarita Gilleo',campus:'Trenton Campus',room:'5'},
{name:'Celeste Rivera',campus:'Trenton Campus',room:'6'},
{name:'Dayana Salinas',campus:'Lawrence Campus',room:'1'},
{name:'Juanny Peralta',campus:'Lawrence Campus',room:'2'},
{name:'Kavita Bharti',campus:'Lawrence Campus',room:'3'},
{name:'Celeste Sarmiento',campus:'Lawrence Campus',room:'4'},
]},
{catKey:'familyWorkers',color:'#9C27B0',icon:String.fromCodePoint(0x1F46A),people:[
{name:'Samira Jurado',campus:'Trenton Campus'},
{name:'Lucrecia Morales',campus:'Trenton Campus'},
{name:'Alissa Garzon-Torres',campus:'Lawrence Campus'},
]},
];
...
<div className='text-center p-4 rounded-2xl border-2 border-dashed hover:shadow-xl transition-all group cursor-pointer' style={{borderColor:color+'50',background:'linear-gradient(135deg,'+color+'08,'+color+'15)'}}>
<div className='flex justify-center mb-3 group-hover:-translate-y-1 group-hover:scale-110 transition-transform'>
<div style={{width:72,height:72,borderRadius:'50%',background:color+'12',display:'flex',alignItems:'center',justifyContent:'center',border:'2px dashed '+color+'40'}}>
<span style={{fontSize:'2rem',lineHeight:1}}>+</span>
</div>
</div>
<div className='font-bold text-sm mb-0.5' style={{fontFamily:'Fredoka',color:color}}>{lang==='es'?'Tu Lugar Nos Espera':'Your Place Awaits'}</div>
<div className='text-xs font-semibold mb-2' style={{fontFamily:'DM Sans',color:'#9CA3AF'}}>{lang==='es'?'Posici\\u00f3n Abierta':'Open Position'}</div>
<div className='inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold' style={{fontFamily:'DM Sans',background:color+'20',color:color}}>{lang==='es'?'Aplica Ahora \\u2192':'Apply Now \\u2192'}</div>
</div>
</Link>
);
}
...
const roomLabel=lang==='es'?'Sal\\u00f3n ':'Classroom ';
...
<p className='text-lg mb-6' style={{fontFamily:'DM Sans',color:'rgba(255,255,255,0.75)',maxWidth:550,margin:'0 auto'}}>{lang==='es'?'Educadores y personal dedicados en dos campus, comprometidos a darle a cada ni\\u00f1o el mejor comienzo en la vida.':'Dedicated educators and staff across two campuses, committed to giving every child the best start in life.'}</p>
...
console.log('Our Team updated:');
console.log('  25 parent-facing staff + 1 open position card');
console.log('  10th Teacher slot: "Your Place Awaits" with Apply Now link to /careers');
console.log('  Dashed border, + icon, hover animation, links to careers page');
console.log('  Non-teaching support staff removed from public view');

...
const openingsES=[
  {
    ...
    duties:[
      'Desarrollar e implementar planes de leccion alineados con los Estandares de Aprendizaje Estudiantil de NJ que atiendan a las diversas habilidades y estilos de aprendizaje de los estudiantes',
      ...
      'Proporcionar apoyo individualizado y tutoria a los estudiantes que requieren ayuda adicional, incluidos los que tienen necesidades de educacion especial',
      'Colaborar con padres, colegas y especialistas para apoyar el desarrollo integral del estudiante',
      'Incorporar educacion literaria, instruccion matematica, educacion fisica y servicios de biblioteca en las lecciones diarias',
      'Apoyar a ninos con autismo y otras necesidades especiales a traves de estrategias de instruccion personalizadas',
      'Participar en oportunidades de desarrollo profesional para mantenerse al dia con las mejores practicas educativas',
    ],
    reqs:[
      ...
      'Experiencia con plataformas de tecnologia de aprendizaje y herramientas digitales',
  ...
  },
  {
    ...
    duties:[
      'Desarrollar e implementar planes de leccion alineados con los Estandares de Aprendizaje Estudiantil de NJ que atiendan a las diversas habilidades y estilos de aprendizaje',
      'Implementar tecnicas efectivas de manejo del salon para mantener un ambiente productivo, positivo e inclusivo',
      'Utilizar plataformas de tecnologia educativa y herramientas digitales para mejorar la instruccion',
      'Evaluar el progreso de los estudiantes a traves de evaluaciones formativas y sumativas y ajustar las estrategias en consecuencia',
      'Proporcionar apoyo individualizado a los estudiantes que requieren ayuda adicional, incluidos los que tienen necesidades especiales',
      'Colaborar con padres, colegas y especialistas para apoyar el desarrollo integral del estudiante',
      'Incorporar educacion literaria, instruccion matematica, educacion fisica y servicios de biblioteca en las lecciones diarias',
      'Apoyar a ninos con autismo y otras necesidades especiales a traves de estrategias de instruccion personalizadas',
      'Participar en oportunidades de desarrollo profesional para mantenerse al dia con las mejores practicas educativas',
